...
export const frame = () => {
    ...
    const group = new THREE.Object3D();
    for(let i = 0;i< 12;i++){
        let geo_xb = new THREE.BoxBufferGeometry(1,1,1);
        let geo_xt = new THREE.BoxBufferGeometry(1,1,1);
        geo_xb.name = 'wall';
        geo_xt.name = 'wall';
    ...
    for(let i = 0;i< 20;i++){
        let geo_yl = new THREE.BoxBufferGeometry(1,1,1);
        let geo_yr = new THREE.BoxBufferGeometry(1,1,1);
        geo_yl.name = 'wall';
        geo_yr.name = 'wall';
